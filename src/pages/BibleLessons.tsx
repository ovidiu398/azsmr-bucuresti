...
const BibleLessons = () => {
  ...
  const currentLesson = {
    ...
    description: [
      ...
      "Lecțiile sunt concepute pentru a ghida atât pe cei aflați la începutul drumului credinței, cât și pe cei care doresc să-și reînnoiască experiența creștină.",
      "Scopul central al acestui studiu este transformarea inimii prin puterea Duhului Sfânt."
    ],
    topics: [
          ...
          <div className="p-8 md:p-12">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
              {currentLesson.topics.map((topic, index) => (
                <li
                  key={index}
                  className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 text-blue-800 font-medium"
                >
